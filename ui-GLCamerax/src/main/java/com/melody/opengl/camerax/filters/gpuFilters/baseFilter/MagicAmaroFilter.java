...
public class MagicAmaroFilter extends GPUImageFilter {
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(() -> {
			inputTextureHandles[0] = OpenGlUtils.loadTexture(GLCameraxUtils.getApplicationContext(), "filter/brannan_blowout.png");
			inputTextureHandles[1] = OpenGlUtils.loadTexture(GLCameraxUtils.getApplicationContext(), "filter/overlaymap.png");
			inputTextureHandles[2] = OpenGlUtils.loadTexture(GLCameraxUtils.getApplicationContext(), "filter/amaromap.png");
		});
	}
}
