...
public class MagicEarlyBirdFilter extends GPUImageFilter {
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(GLCameraxUtils.getApplicationContext(), "filter/earlybirdcurves.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(GLCameraxUtils.getApplicationContext(), "filter/earlybirdoverlaymap_new.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(GLCameraxUtils.getApplicationContext(), "filter/vignettemap_new.png");
				inputTextureHandles[3] = OpenGlUtils.loadTexture(GLCameraxUtils.getApplicationContext(), "filter/earlybirdblowout.png");
				inputTextureHandles[4] = OpenGlUtils.loadTexture(GLCameraxUtils.getApplicationContext(), "filter/earlybirdmap.png");
		    }
	    });
	}
}
