...
public class MagicSierraFilter extends GPUImageFilter {
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(GLCameraxUtils.getApplicationContext(), "filter/sierravignette.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(GLCameraxUtils.getApplicationContext(), "filter/overlaymap.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(GLCameraxUtils.getApplicationContext(), "filter/sierramap.png");
		    }
	    });
	}
}