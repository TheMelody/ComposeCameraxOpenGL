...
public class MagicSutroFilter extends GPUImageFilter {
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(GLCameraxUtils.getApplicationContext(), "filter/vignette_map.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(GLCameraxUtils.getApplicationContext(), "filter/sutrometal.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(GLCameraxUtils.getApplicationContext(), "filter/softlight.png");
				inputTextureHandles[3] = OpenGlUtils.loadTexture(GLCameraxUtils.getApplicationContext(), "filter/sutroedgeburn.png");
				inputTextureHandles[4] = OpenGlUtils.loadTexture(GLCameraxUtils.getApplicationContext(), "filter/sutrocurves.png");
		    }
	    });
	}
}