...
public class MagicToasterFilter extends GPUImageFilter {
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(GLCameraxUtils.getApplicationContext(), "filter/toastermetal.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(GLCameraxUtils.getApplicationContext(), "filter/toastersoftlight.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(GLCameraxUtils.getApplicationContext(), "filter/toastercurves.png");
				inputTextureHandles[3] = OpenGlUtils.loadTexture(GLCameraxUtils.getApplicationContext(), "filter/toasteroverlaymapwarm.png");
				inputTextureHandles[4] = OpenGlUtils.loadTexture(GLCameraxUtils.getApplicationContext(), "filter/toastercolorshift.png");
		    }
	    });
	}
}
