package com.melody.camerax_compose.base

import androidx.lifecycle.*
import com.melody.camerax_compose.extensions.add
...
abstract class BaseViewModel<Event : IUiEvent, State : IUiState, Effect : IUiEffect> :
    ...
    /**
     * 获取当前视图状态值：
     * compose函数里面【不能直接用value值】，需要uiState.collectAsState()获取State<IUiState>;
     * 此处的currentState是用在viewModel中的；
     */
